...
//последнего должно отобразиться среднее число символов на странице (общее количество символов в резюме / количество MessageBox’ов).
    public partial class Form1 : Form
    {
        ...
        {
            string[] array = { "Студент: Ірина Володимирівна", "Предмет: Windows Forms", "Група: БВ-111" };
            int numSymbol = 0;
            string caption;
            ...
            for (int i = 0; i < array.Length; i++)
            {
                ...
                caption = (array.Length-1 == i)?$"MessageBox {i+1}. Середнє число символів- {numSymbol/array.Length}":$"MessageBox {i+1}";
